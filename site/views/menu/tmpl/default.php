                    ...
                    <ul class="jomoerm_onecol" style="list-style: none;">
                        <li>
                            ...
                            <span class="jomoerm_price">
                                <?php if ($adish->dish_icon): ?>
                                    <img src="media/com_jomoeasyrestaurantmenu/icons/<?php echo $adish->dish_icon; ?>"                                 
                                         alt="tooltippic"/>
                                     <?php endif; ?>
                                <?php if ($adish->price > 0)
                                echo $adish->price . ' ' . $this->params->get('currency'); ?></span>
                            ...
                            <?php else: // links off ?>
                                ...
                                echo $this->params->get('attrName'); ?>"><img src="<?php echo $adish->dish_img; ?>" class="jomoerm_menuthumb"/></a>
                            <?php endif; ?>
                            ...
                            <span class="jomoerm_price">
                                <?php if ($adish->dish_icon): ?>
                                    <img src="media/com_jomoeasyrestaurantmenu/icons/<?php echo $adish->dish_icon; ?>"                                 
                                     ...
                                     <?php endif; ?>
                                <?php if ($adish->price > 0)
                                echo $adish->price . ' ' . $this->params->get('currency'); 
                                ?></span>
                            <?php if ($this->params->get('enableLinks') == 0): // links on ?>
                            <img src="<?php echo $adish->dish_img; ?>" class="jomoerm_menuthumb"/>            
                            <?php else: // links off ?>
