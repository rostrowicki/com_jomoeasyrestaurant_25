...
class JomoeasyrestaurantmenuViewMenu extends JView {
    ...
    protected function addToolbar() {
        ...
        if ($this->item->id) {
            JToolBarHelper::title(JText::_('COM_JOMOEASYRESTAURANTMENU_EDIT_MENU'), 'jomo');
        } else {
            JToolBarHelper::title(JText::_('COM_JOMOEASYRESTAURANTMENU_NEW_MENU'), 'jomo');
        }
